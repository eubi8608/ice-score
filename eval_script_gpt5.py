from llm_code_eval.evaluator import evaluate, evaluate_qwen, evaluate_gpt5
import re
import json
...
def main():
    ...
    if args.ref == "True":
        output_file = "data/humaneval/humaneval_llm_eval_gpt5_r_ref.json"
    else:
        output_file = "data/humaneval/humaneval_llm_eval_gpt5_r.json"
...
# score = evaluate_gpt5(problem="Given a list of integers, return the sum of all the integers.", 
